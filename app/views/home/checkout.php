                ...
                <form>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="fullname"
                            placeholder="<?php echo $user['full_name']; ?>" readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" class="form-control" id="phone" placeholder="<?php echo $user['phone']; ?>"
                            readonly>
                    </div>
                    <div class="mb-3">
                        <label for="address" class="form-label">Địa chỉ giao hàng</label>
                        <input type="text" class="form-control" id="address"
                            placeholder="<?php echo $user['address']; ?>" readonly></input>
                    </div>
                </form>
                <div class="mt-4 text-center"> <a href="index.php?page=profile" class="btn btn-danger btn-lg">Sửa thông
                        tin nhận hàng</a> </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="bg-white p-4 rounded shadow-sm">
                    ...
                    <table class="table table-borderless">
                            ...
                            <?php foreach ($cart as $c): ?>
                                <tr>
                                    <td><?php echo $c['product_name']; ?><br>
                                        <small class="text-muted">Size: <?php echo $c['size']; ?> | Màu:
                                            <?php echo $c['color']; ?></small><br>
                                        <small class="text-muted">Số lượng: <?php echo $c['quantity']; ?></small>
                                    </td>
                                    <td class="text-end">
                                        <?php echo number_format($c['price'] * $c['quantity'], 0, ',', '.');
                        ...
                        <tfoot>
                            ...
                            <tr class="fw-bold">
                                ...
                                <td class="text-end text-primary"><?php echo number_format($tong, 0, ',', '.'); ?> vnđ
                                </td>
                            </tr>
                        </tfoot>
                    </table>
                ...
                <form method="post">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="payment_method" id="bank" value="BANKING">
